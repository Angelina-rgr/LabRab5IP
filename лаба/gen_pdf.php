...
$reportName = "Cars";
$reportNameYPos = 160;
$columnLabels = array( "Model", "Marka", "Year", "Transmission","Cost" );
$j=0;
while ($row=mysqli_fetch_array($result)){
$rowLabels[$j] = $row['id_car'];
$j++;
}
$chartXPos = 20;
$chartYPos = 250;
...
// Ячейка "PRODUCT"
$pdf->SetTextColor( $tableHeaderTopProductTextColour[0], $tableHeaderTopProductTextColour[1], 
$tableHeaderTopProductTextColour[2] );
$pdf->SetFillColor( $tableHeaderTopProductFillColour[0], $tableHeaderTopProductFillColour[1], 
$tableHeaderTopProductFillColour[2] );
